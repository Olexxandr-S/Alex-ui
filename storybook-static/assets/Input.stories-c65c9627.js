var d=Object.defineProperty;var l=(n,a)=>d(n,"name",{value:a,configurable:!0});import{j as e}from"./jsx-runtime-7804b9f5.js";import{B as h}from"./Button-c1374c2c.js";import{r as f}from"./index-1646b246.js";import{c as x}from"./clsx.m-26950cc3.js";import{L as I}from"./Label-44bbd9bc.js";import"./Text-f7dd7c67.js";import"./iframe-814bc0b2.js";const y="_inputWrapper_q3u82_1",_="_withElementRight_q3u82_21",g="_input_q3u82_1",r={inputWrapper:y,"scale-s":"_scale-s_q3u82_11","scale-m":"_scale-m_q3u82_14",withElementRight:_,input:g},t=f.forwardRef((n,a)=>{const{scale:s,label:p,elementRight:o,wide:i,className:c,...u}=n,m=x(r.inputWrapper,c,{[r[`scale-${s}`]]:s,[r.withElementRight]:!!o});return e.jsx(I,{label:p,wide:i,children:e.jsxs("span",{className:m,children:[e.jsx("input",{className:r.input,ref:a,...u}),o&&e.jsx("span",{children:o})]})})});t.displayName="Input";t.defaultProps={scale:"m",type:"text",label:null,elementRight:null,wide:!0};try{t.displayName="Input",t.__docgenInfo={description:"",displayName:"Input",props:{scale:{defaultValue:{value:"m"},description:"",name:"scale",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"m"'}]}},type:{defaultValue:{value:"text"},description:"",name:"type",required:!1,type:{name:'"number" | "color" | "hidden" | "button" | "submit" | "reset" | "search" | (string & {}) | "text" | "tel" | "url" | "email" | "date" | "time" | "datetime-local" | "file" | "image" | ... 4 more ...'}},label:{defaultValue:{value:"null"},description:"",name:"label",required:!1,type:{name:"ReactNode"}},elementRight:{defaultValue:{value:"null"},description:"",name:"elementRight",required:!1,type:{name:"ReactNode"}},wide:{defaultValue:{value:"true"},description:"",name:"wide",required:!1,type:{name:"boolean"}}}}}catch{}const C={parameters:{storySource:{source:`import { ComponentMeta, ComponentStory } from '@storybook/react';\r
...
//# sourceMappingURL=Input.stories-c65c9627.js.map
